...
Версия `0.0.7` дорабатывает первый игровой экран: центр города теперь можно
поставить выбранной точкой, недоступные постройки показывают причину отказа,
океанские точки запрещены для строительства, выбранная точка подсвечивается,
а строительство больше не перефокусирует карту. Добавлены активация,
деактивация и снос построек, работники у активных зданий, стрелки тенденции
ресурсов, пропуск месяца и года с предупреждением о риске нехватки, полный
журнал статуса, бетонный завод и недельный номер в календаре. Дети потребляют
половину еды и воды, взрослеют через 16 лет и больше не остаются бессмертными.
...
Доработки версии 0.0.7 описаны в
[`docs/version-0.0.7-design.md`](docs/version-0.0.7-design.md).
